...
import com.campelo.osvictor.api.model.ComentarioInput;
import com.campelo.osvictor.api.model.ComentarioModel;
...
import com.campelo.osvictor.domain.service.GestaoOrdemServicoService;
...
public class ComentarioController {
	...
	public List<ComentarioModel> listar(@PathVariable Long ordemServicoId) {
		OrdemServico ordemServico = ordemServicoRepository.findById(ordemServicoId)
				.orElseThrow(()-> new EntidadeNaoEncontradaException("Ordem de servico não encotrada"));
